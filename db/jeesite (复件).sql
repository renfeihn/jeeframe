...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ge_bytearray`;
CREATE TABLE  `jeesite`.`act_ge_bytearray` (
...
-- ----------------------------
-- Table stact_ge_propertyructure for act_ge_property
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ge_property`;
CREATE TABLE  `jeesite`.`act_ge_property` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_actinst`;
CREATE TABLE  `jeesite`.`act_hi_actinst` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_attachment`;
CREATE TABLE  `jeesite`.`act_hi_attachment` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_comment`;
CREATE TABLE  `jeesite`.`act_hi_comment` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `TYPE_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_detail`;
CREATE TABLE  `jeesite`.`act_hi_detail` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_identitylink`;
CREATE TABLE  `jeesite`.`act_hi_identitylink` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_procinst`;
CREATE TABLE  `jeesite`.`act_hi_procinst` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `PROC_INST_ID_` varchar(64) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_taskinst`;
CREATE TABLE  `jeesite`.`act_hi_taskinst` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_hi_varinst`;
CREATE TABLE  `jeesite`.`act_hi_varinst` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `PROC_INST_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `EXECUTION_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `TASK_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_id_group`;
CREATE TABLE  `jeesite`.`act_id_group` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
  `NAME_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYPE_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_id_info`;
CREATE TABLE  `jeesite`.`act_id_info` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_id_membership`;
CREATE TABLE  `jeesite`.`act_id_membership` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_id_user`;
CREATE TABLE  `jeesite`.`act_id_user` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_re_deployment`;
CREATE TABLE  `jeesite`.`act_re_deployment` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `NAME_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `CATEGORY_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TENANT_ID_` varchar(255) COLLATE utf8_bin DEFAULT '',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_re_model`;
CREATE TABLE  `jeesite`.`act_re_model` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
  `NAME_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `KEY_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_re_procdef`;
CREATE TABLE  `jeesite`.`act_re_procdef` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
  `CATEGORY_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `NAME_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_event_subscr`;
CREATE TABLE  `jeesite`.`act_ru_event_subscr` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_execution`;
CREATE TABLE  `jeesite`.`act_ru_execution` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
  `PROC_INST_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `BUSINESS_KEY_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_identitylink`;
CREATE TABLE  `jeesite`.`act_ru_identitylink` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
  `GROUP_ID_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `TYPE_` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_job`;
CREATE TABLE  `jeesite`.`act_ru_job` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
  `TYPE_` varchar(255) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_task`;
CREATE TABLE  `jeesite`.`act_ru_task` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `REV_` int(11) DEFAULT NULL,
  `EXECUTION_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `PROC_INST_ID_` varchar(64) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`act_ru_variable`;
CREATE TABLE  `jeesite`.`act_ru_variable` (
  `ID_` varchar(64) COLLATE utf8_bin NOT NULL,
  `REV_` int(11) DEFAULT NULL,
  `TYPE_` varchar(255) COLLATE utf8_bin NOT NULL,
  `NAME_` varchar(255) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_article`;
CREATE TABLE  `jeesite`.`cms_article` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_article_data`;
CREATE TABLE  `jeesite`.`cms_article_data` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_category`;
CREATE TABLE  `jeesite`.`cms_category` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_comment`;
CREATE TABLE  `jeesite`.`cms_comment` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `category_id` varchar(64) NOT NULL COMMENT '栏目编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_guestbook`;
CREATE TABLE  `jeesite`.`cms_guestbook` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_link`;
CREATE TABLE  `jeesite`.`cms_link` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `category_id` varchar(64) NOT NULL COMMENT '栏目编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`cms_site`;
CREATE TABLE  `jeesite`.`cms_site` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`gen_scheme`;
CREATE TABLE  `jeesite`.`gen_scheme` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
INSERT INTO `gen_scheme` VALUES ('35a13dc260284a728a270db3f382664b', '树结构', 'treeTable', 'com.renfeihn.jeeframe.modules', 'test', null, '树结构生成', '树结构', 'ThinkGem', 'f6e4dafaa72f4c509636484715f33a96', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_scheme` VALUES ('9c9de9db6da743bb899036c6546061ac', '单表', 'curd', 'com.renfeihn.jeeframe.modules', 'test', null, '单表生成', '单表', 'ThinkGem', 'aef6f1fc948f4c9ab1c1b780bc471cc2', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_scheme` VALUES ('e6d905fd236b46d1af581dd32bdfb3b0', '主子表', 'curd_many', 'com.renfeihn.jeeframe.modules', 'test', null, '主子表生成', '主子表', 'ThinkGem', '43d6d5acffa14c258340ce6765e46c6f', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');

-- ----------------------------
-- Table structure for gen_table
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`gen_table`;
CREATE TABLE  `jeesite`.`gen_table` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `name` varchar(200) DEFAULT NULL COMMENT '名称',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`gen_table_column`;
CREATE TABLE  `jeesite`.`gen_table_column` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
INSERT INTO `gen_table_column` VALUES ('12fa38dd986e41908f7fefa5839d1220', '6e05c389f3c6415ea34e55e9dfb28934', 'create_by', '创建者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, '4', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('195ee9241f954d008fe01625f4adbfef', 'f6e4dafaa72f4c509636484715f33a96', 'create_by', '创建者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, '6', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('1d5ca4d114be41e99f8dc42a682ba609', 'aef6f1fc948f4c9ab1c1b780bc471cc2', 'user_id', '归属用户', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'user.id|name', '0', '1', '1', '1', '1', '1', '=', 'userselect', null, null, '2', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('21756504ffdc487eb167a823f89c0c06', '43d6d5acffa14c258340ce6765e46c6f', 'update_by', '更新者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, '10', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('398b4a03f06940bfb979ca574e1911e3', 'aef6f1fc948f4c9ab1c1b780bc471cc2', 'create_by', '创建者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, '8', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('3a7cf23ae48a4c849ceb03feffc7a524', '43d6d5acffa14c258340ce6765e46c6f', 'area_id', '归属区域', 'nvarchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.Area', 'area.id|name', '0', '1', '1', '1', '0', '0', '=', 'areaselect', null, null, '4', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('56fa71c0bd7e4132931874e548dc9ba5', '6e05c389f3c6415ea34e55e9dfb28934', 'update_by', '更新者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, '6', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('5a4a1933c9c844fdba99de043dc8205e', 'aef6f1fc948f4c9ab1c1b780bc471cc2', 'update_by', '更新者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, '10', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('71ea4bc10d274911b405f3165fc1bb1a', 'aef6f1fc948f4c9ab1c1b780bc471cc2', 'area_id', '归属区域', 'nvarchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.Area', 'area.id|name', '0', '1', '1', '1', '1', '1', '=', 'areaselect', null, null, '4', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('8b48774cfe184913b8b5eb17639cf12d', '43d6d5acffa14c258340ce6765e46c6f', 'create_by', '创建者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, '8', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('8b9de88df53e485d8ef461c4b1824bc1', '43d6d5acffa14c258340ce6765e46c6f', 'user_id', '归属用户', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'user.id|name', '0', '1', '1', '1', '1', '1', '=', 'userselect', null, null, '2', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
INSERT INTO `gen_table_column` VALUES ('ad3bf0d4b44b4528a5211a66af88f322', 'aef6f1fc948f4c9ab1c1b780bc471cc2', 'office_id', '归属部门', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.Office', 'office.id|name', '0', '1', '1', '1', '1', '1', '=', 'officeselect', null, null, '3', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('bb1256a8d1b741f6936d8fed06f45eed', 'f6e4dafaa72f4c509636484715f33a96', 'update_by', '更新者', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.User', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, '8', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
INSERT INTO `gen_table_column` VALUES ('ca68a2d403f0449cbaa1d54198c6f350', '43d6d5acffa14c258340ce6765e46c6f', 'office_id', '归属部门', 'varchar2(64)', 'com.renfeihn.jeeframe.modules.modules.sys.entity.Office', 'office.id|name', '0', '1', '1', '1', '0', '0', '=', 'officeselect', null, null, '3', '1', '2013-08-12 13:10:05', '1', '2013-08-12 13:10:05', null, '0');
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`gen_template`;
CREATE TABLE  `jeesite`.`gen_template` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `name` varchar(200) DEFAULT NULL COMMENT '名称',
  `category` varchar(2000) DEFAULT NULL COMMENT '分类',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`oa_leave`;
CREATE TABLE  `jeesite`.`oa_leave` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`oa_notify`;
CREATE TABLE  `jeesite`.`oa_notify` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`oa_notify_record`;
CREATE TABLE  `jeesite`.`oa_notify_record` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`oa_test_audit`;
CREATE TABLE  `jeesite`.`oa_test_audit` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_area`;
CREATE TABLE  `jeesite`.`sys_area` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) NOT NULL COMMENT '所有父级编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_dict`;
CREATE TABLE  `jeesite`.`sys_dict` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
INSERT INTO `sys_dict` VALUES ('101', 'com.renfeihn.jeeframe.modules.sys.entity.User', 'User', 'gen_java_type', 'Java类型\0\0', '60', '0', '1', '2013-10-28 08:00:00', '1', '2013-10-28 08:00:00', null, '1');
INSERT INTO `sys_dict` VALUES ('102', 'com.renfeihn.jeeframe.modules.sys.entity.Office', 'Office', 'gen_java_type', 'Java类型\0\0', '70', '0', '1', '2013-10-28 08:00:00', '1', '2013-10-28 08:00:00', null, '1');
INSERT INTO `sys_dict` VALUES ('103', 'com.renfeihn.jeeframe.modules.sys.entity.Area', 'Area', 'gen_java_type', 'Java类型\0\0', '80', '0', '1', '2013-10-28 08:00:00', '1', '2013-10-28 08:00:00', null, '1');
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_log`;
CREATE TABLE  `jeesite`.`sys_log` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_mdict`;
CREATE TABLE  `jeesite`.`sys_mdict` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) NOT NULL COMMENT '所有父级编号',
  `name` varchar(100) NOT NULL COMMENT '名称',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_menu`;
CREATE TABLE  `jeesite`.`sys_menu` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) NOT NULL COMMENT '所有父级编号',
  `name` varchar(100) NOT NULL COMMENT '名称',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_office`;
CREATE TABLE  `jeesite`.`sys_office` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) NOT NULL COMMENT '所有父级编号',
  `name` varchar(100) NOT NULL COMMENT '名称',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_role`;
CREATE TABLE  `jeesite`.`sys_role` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `office_id` varchar(64) DEFAULT NULL COMMENT '归属机构',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_role_menu`;
CREATE TABLE  `jeesite`.`sys_role_menu` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_role_office`;
CREATE TABLE  `jeesite`.`sys_role_office` (
  `role_id` varchar(64) NOT NULL COMMENT '角色编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_user`;
CREATE TABLE  `jeesite`.`sys_user` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '2', 'admin', '02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032', '0001', '系统管理员', 'thinkgem@163.com', '8675', '8675', null, null, null, null, '1', '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', '最高管理员', '0');
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`sys_user_role`;
CREATE TABLE  `jeesite`.`sys_user_role` (
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`test_data`;
CREATE TABLE  `jeesite`.`test_data` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`test_data_child`;
CREATE TABLE  `jeesite`.`test_data_child` (
  `id` varchar(64) NOT NULL COMMENT '编号',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`test_data_main`;
CREATE TABLE  `jeesite`.`test_data_main` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `user_id` varchar(64) DEFAULT NULL COMMENT '归属用户',
  `office_id` varchar(64) DEFAULT NULL COMMENT '归属部门',
  `area_id` varchar(64) DEFAULT NULL COMMENT '归属区域',
...
-- ----------------------------
DROP TABLE IF EXISTS `jeesite`.`test_tree`;
CREATE TABLE  `jeesite`.`test_tree` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) NOT NULL COMMENT '所有父级编号',
  `name` varchar(100) NOT NULL COMMENT '名称',
